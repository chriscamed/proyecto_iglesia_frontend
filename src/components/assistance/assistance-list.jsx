...
class AssistanceList extends Component {
  ...
  <div className="navbar-end">
      ...
      <button className="button is-info is-inverted is-outlined" onClick={this._handleLogout}>
        ...
        <h3 className="title has-text-centered">REGISTRAR ASISTENTE EN EVENTO</h3>
              ...
              <tbody>
                ...
                currPage.data.map(eventos => (
                  ...
                  <tr key={eventos.ID_EVENTO}>
                    ...
                    <td style={{textAlign: 'center'}}><Link to={{pathname:"/createassi/"+eventos.ID_EVENTO+"/"+eventos.NOMBRE,state:{roll: this.props.confirm.roll}}}>Entrar</Link></td>
                    <td><Link  to={{pathname:"/generarqr",state:{evento:eventos.ID_EVENTO}} }>Generar</Link></td>
                  </tr>
...
export default withAuth(AssistanceList);
