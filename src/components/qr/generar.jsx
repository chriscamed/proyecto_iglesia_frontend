...
class Generar extends Component{
  ...
  render() {
    ...
    var cadena= this.props.history.location.state.evento+","+localStorage.getItem('id_token');
    return(
    <div>
  ...
  <div className="navbar-end">
      ...
      <br/><br/><br/><br/><br/>
      <div class="content has-text-centered"><QRCode value={cadena} size="200"/></div>
      <Link to="/assistancelist" className="button is-rounded is-medium is-fullwidth" style={{backgroundColor:`#64234A`, color: `#FFF` }}> REGRESAR A LISTADO DE ASISTENCIA</Link>
    </div>
  );
  }
}
export default withAuth(Generar);
